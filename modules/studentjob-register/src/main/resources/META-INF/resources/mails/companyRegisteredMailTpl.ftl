...
<body style="background-color:#f3f3f5;">
  ...
  <div style="background-color:#f3f3f5;">
    ...
    <!--[if mso | IE]>
      ...
      <![endif]-->
    <div style="background:#193A6F url(https://www.transparenttextures.com/patterns/brushed-alum.png) top center / auto repeat;margin:0px auto;border-radius:4px 4px 0 0;max-width:600px;">
      <div style="line-height:0;font-size:0;">
        <table role="presentation" style="background:#193A6F url(https://www.transparenttextures.com/patterns/brushed-alum.png) top center / auto repeat;width:100%;border-radius:4px 4px 0 0;" cellspacing="0" cellpadding="0" border="0" background="https://www.transparenttextures.com/patterns/brushed-alum.png" align="center">
          <tbody>
            <tr>
              <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                <!--[if mso | IE]>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="width:200px;">
                                        <img src="https://i.ibb.co/JdksWPR/studentjob-dark.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="200" height="auto" />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                    ...
                    <tr>
                      <td style="font-size:0px;padding:10px 25px;word-break:break-word;" align="left">
                        <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:20px;font-weight:300;line-height:30px;text-align:left;color:#003366;">
                          <h1 style="margin: 0; font-size: 32px; line-height: 50px; font-weight: 400;"> ${new-company-user-requires-approval} </h1>
                        </div>
                      </td>
                    </tr>
                      <tr>
    ...
    <div style="background:#d5d5d5;background-color:#d5d5d5;margin:0px auto;max-width:600px;">
      <table role="presentation" style="background:#d5d5d5;background-color:#d5d5d5;width:100%;" cellspacing="0" cellpadding="0" border="0" align="center">
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
              <!--[if mso | IE]>
                  ...
                  <tbody><tr>
                    <td style="font-size:0px;padding:10px 25px;word-break:break-word;" align="left">
                      <div style="font-family:Poppins, Helvetica, Arial, sans-serif;font-size:14px;font-weight:300;line-height:20px;text-align:left;color:#11224D;">
                        <p style="margin: 0;"> ${you-can-unsuscribe} </p>
                      </div>
                    </td>
                  </tr>
                </tbody></table>
    ...
    <!--[if mso | IE]>
      ...
      >
        <tr>
          <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
      <![endif]-->
    <div style="background:#11224D;background-color:#11224D;margin:0px auto;max-width:600px;">
      <table role="presentation" style="background:#11224D;background-color:#11224D;width:100%;" cellspacing="0" cellpadding="0" border="0" align="center">
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
              <!--[if mso | IE]>
