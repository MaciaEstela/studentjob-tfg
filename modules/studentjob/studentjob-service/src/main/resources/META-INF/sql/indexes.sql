create index IX_B73E8C03 on SJob_CompanyProfile (groupId);
...
create index IX_C4638D1D on SJob_Offer (groupId);
...
create index IX_60160658 on SJob_SocialMediaNetwork (groupId);
...
create index IX_17A31E41 on SJob_StudentProfile (groupId);
