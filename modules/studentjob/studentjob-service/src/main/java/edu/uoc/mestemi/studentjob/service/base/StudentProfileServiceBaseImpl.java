...
/**
 * Provides the base implementation for the student profile remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.uoc.mestemi.studentjob.service.impl.StudentProfileServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see edu.uoc.mestemi.studentjob.service.impl.StudentProfileServiceImpl
 * @generated
 */
public abstract class StudentProfileServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, StudentProfileService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StudentProfileService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StudentProfileServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StudentProfileService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		studentProfileService = (StudentProfileService)aopProxy;

		_setServiceUtilService(studentProfileService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StudentProfileService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = StudentProfileServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, studentProfileService);
		}
	...
	@Reference
	protected edu.uoc.mestemi.studentjob.service.StudentProfileLocalService
