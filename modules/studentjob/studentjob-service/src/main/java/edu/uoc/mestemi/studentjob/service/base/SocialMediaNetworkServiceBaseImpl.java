...
/**
 * Provides the base implementation for the social media network remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.uoc.mestemi.studentjob.service.impl.SocialMediaNetworkServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see edu.uoc.mestemi.studentjob.service.impl.SocialMediaNetworkServiceImpl
 * @generated
 */
public abstract class SocialMediaNetworkServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SocialMediaNetworkService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SocialMediaNetworkService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SocialMediaNetworkServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SocialMediaNetworkService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		socialMediaNetworkService = (SocialMediaNetworkService)aopProxy;

		_setServiceUtilService(socialMediaNetworkService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SocialMediaNetworkService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = SocialMediaNetworkServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, socialMediaNetworkService);
		}
	...
	@Reference
	protected edu.uoc.mestemi.studentjob.service.SocialMediaNetworkLocalService
