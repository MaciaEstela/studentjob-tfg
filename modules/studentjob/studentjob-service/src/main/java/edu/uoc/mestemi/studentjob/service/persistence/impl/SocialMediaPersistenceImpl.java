...
public class SocialMediaPersistenceImpl
	 ...
	 */
	@Override
	public List<SocialMedia> findByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<SocialMedia> findByGroupId(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public List<SocialMedia> findByGroupId(
	...
	public SocialMedia findByGroupId_First(
		...
		SocialMedia socialMedia = fetchByGroupId_First(
	...
	public SocialMedia fetchByGroupId_First(
		...
		List<SocialMedia> list = findByGroupId(
	...
	public SocialMedia findByGroupId_Last(
		...
		SocialMedia socialMedia = fetchByGroupId_Last(
			groupId, orderByComparator);
	...
	public SocialMedia[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, socialMedia, groupId, orderByComparator, true);

			array[1] = socialMedia;

			array[2] = getByGroupId_PrevAndNext(
				session, socialMedia, groupId, orderByComparator, false);
	...
	protected SocialMedia getByGroupId_PrevAndNext(
