...
/**
 * Provides the base implementation for the user enroll offer remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.uoc.mestemi.studentjob.service.impl.UserEnrollOfferServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see edu.uoc.mestemi.studentjob.service.impl.UserEnrollOfferServiceImpl
 * @generated
 */
public abstract class UserEnrollOfferServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, UserEnrollOfferService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UserEnrollOfferService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>UserEnrollOfferServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UserEnrollOfferService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		userEnrollOfferService = (UserEnrollOfferService)aopProxy;

		_setServiceUtilService(userEnrollOfferService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserEnrollOfferService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = UserEnrollOfferServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, userEnrollOfferService);
		}
	...
	@Reference
	protected edu.uoc.mestemi.studentjob.service.UserEnrollOfferLocalService
