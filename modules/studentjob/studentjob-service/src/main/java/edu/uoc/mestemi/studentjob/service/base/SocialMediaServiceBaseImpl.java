...
/**
 * Provides the base implementation for the social media remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.uoc.mestemi.studentjob.service.impl.SocialMediaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see edu.uoc.mestemi.studentjob.service.impl.SocialMediaServiceImpl
 * @generated
 */
public abstract class SocialMediaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SocialMediaService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SocialMediaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SocialMediaServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SocialMediaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		socialMediaService = (SocialMediaService)aopProxy;

		_setServiceUtilService(socialMediaService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SocialMediaService.class.getName();
	}
	...
	private void _setServiceUtilService(SocialMediaService socialMediaService) {
		try {
			Field field = SocialMediaServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, socialMediaService);
		}
	...
	@Reference
	protected edu.uoc.mestemi.studentjob.service.SocialMediaLocalService
