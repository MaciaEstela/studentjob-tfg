...
/**
 * Provides the base implementation for the degree area remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.uoc.mestemi.studentjob.service.impl.DegreeAreaServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see edu.uoc.mestemi.studentjob.service.impl.DegreeAreaServiceImpl
 * @generated
 */
public abstract class DegreeAreaServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DegreeAreaService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DegreeAreaService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DegreeAreaServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DegreeAreaService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		degreeAreaService = (DegreeAreaService)aopProxy;

		_setServiceUtilService(degreeAreaService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DegreeAreaService.class.getName();
	}
	...
	private void _setServiceUtilService(DegreeAreaService degreeAreaService) {
		try {
			Field field = DegreeAreaServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, degreeAreaService);
		}
	...
	@Reference
	protected edu.uoc.mestemi.studentjob.service.DegreeAreaLocalService
