...
import edu.uoc.mestemi.studentjob.service.persistence.OfferUtil;
 ...
 * @generated
 */
@Component(service = {OfferPersistence.class, BasePersistence.class})
public class OfferPersistenceImpl
	...
	public List<Offer> findByUuid(
		...
		if (useFinderCache) {
			list = (List<Offer>)finderCache.getResult(finderPath, finderArgs);
	 ...
	 */
	@Override
	public List<Offer> findByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<Offer> findByGroupId(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public List<Offer> findByGroupId(
	 ...
	 */
	@Override
	public Offer findByGroupId_First(
			long groupId, OrderByComparator<Offer> orderByComparator)
		throws NoSuchOfferException {

		Offer offer = fetchByGroupId_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Offer fetchByGroupId_First(
		long groupId, OrderByComparator<Offer> orderByComparator) {

		List<Offer> list = findByGroupId(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Offer findByGroupId_Last(
			long groupId, OrderByComparator<Offer> orderByComparator)
		throws NoSuchOfferException {

		Offer offer = fetchByGroupId_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Offer fetchByGroupId_Last(
		long groupId, OrderByComparator<Offer> orderByComparator) {
	 ...
	 */
	@Override
	public Offer[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, offer, groupId, orderByComparator, true);

			array[1] = offer;

			array[2] = getByGroupId_PrevAndNext(
				session, offer, groupId, orderByComparator, false);
	...
	protected Offer getByGroupId_PrevAndNext(
		Session session, Offer offer, long groupId,
		OrderByComparator<Offer> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Offer> findByGroupIdAndUserId(long groupId, long userId) {
	 ...
	 */
	@Override
	public List<Offer> findByGroupIdAndUserId(
	...
	public Offer findByGroupIdAndUserId_First(
		...
		Offer offer = fetchByGroupIdAndUserId_First(
	...
	public Offer fetchByGroupIdAndUserId_First(
		...
		List<Offer> list = findByGroupIdAndUserId(
	...
	public Offer findByGroupIdAndUserId_Last(
		...
		Offer offer = fetchByGroupIdAndUserId_Last(
			groupId, userId, orderByComparator);
	...
	public Offer[] findByGroupIdAndUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupIdAndUserId_PrevAndNext(
				session, offer, groupId, userId, orderByComparator, true);

			array[1] = offer;

			array[2] = getByGroupIdAndUserId_PrevAndNext(
				session, offer, groupId, userId, orderByComparator, false);
	...
	protected Offer getByGroupIdAndUserId_PrevAndNext(
		Session session, Offer offer, long groupId, long userId,
		OrderByComparator<Offer> orderByComparator, boolean previous) {
	...
	protected Offer removeImpl(Offer offer) {
		offerToDegreeTableMapper.deleteLeftPrimaryKeyTableMappings(
			offer.getPrimaryKey());
	...
	public long[] getDegreePrimaryKeys(long pk) {
		long[] pks = offerToDegreeTableMapper.getRightPrimaryKeys(pk);
	 ...
	 */
	@Override
	public List<Offer> getDegreeOffers(long pk) {
		return getDegreeOffers(pk, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	}
	 ...
	 */
	@Override
	public List<Offer> getDegreeOffers(long pk, int start, int end) {
		return getDegreeOffers(pk, start, end, null);
	}
	...
	public List<Offer> getDegreeOffers(
		...
		return offerToDegreeTableMapper.getLeftBaseModels(
	...
	public boolean containsDegree(long pk, long degreePK) {
		return offerToDegreeTableMapper.containsTableMapping(pk, degreePK);
	}
	...
	public void addDegree(long pk, long degreePK) {
		Offer offer = fetchByPrimaryKey(pk);

		if (offer == null) {
			offerToDegreeTableMapper.addTableMapping(
				CompanyThreadLocal.getCompanyId(), pk, degreePK);
		}
		else {
			offerToDegreeTableMapper.addTableMapping(
				offer.getCompanyId(), pk, degreePK);
		}
	}
	...
	public void addDegree(long pk, Degree degree) {
		...
		if (offer == null) {
			...
			offerToDegreeTableMapper.addTableMapping(
				offer.getCompanyId(), pk, degree.getPrimaryKey());
		}
	}
	...
	public void addDegrees(long pk, long[] degreePKs) {
		...
		offerToDegreeTableMapper.addTableMappings(companyId, pk, degreePKs);
	}
	...
	public void clearDegrees(long pk) {
		offerToDegreeTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
	}
	...
	public void removeDegree(long pk, long degreePK) {
		offerToDegreeTableMapper.deleteTableMapping(pk, degreePK);
	}
	...
	public void removeDegree(long pk, Degree degree) {
		offerToDegreeTableMapper.deleteTableMapping(pk, degree.getPrimaryKey());
	}
	...
	public void removeDegrees(long pk, long[] degreePKs) {
		offerToDegreeTableMapper.deleteTableMappings(pk, degreePKs);
	}
	...
	public void setDegrees(long pk, long[] degreePKs) {
		...
		offerToDegreeTableMapper.addTableMappings(
	...
	public void activate() {
		...
		offerToDegreeTableMapper = TableMapperFactory.getTableMapper(
			"SJob_Offers_Degrees#offerId", "SJob_Offers_Degrees", "companyId",
			"offerId", "degreeId", this, Degree.class);
	...
	public void deactivate() {
		...
		TableMapperFactory.removeTableMapper("SJob_Offers_Degrees#offerId");
	}
	...
	protected TableMapper<Offer, Degree> offerToDegreeTableMapper;
	...
	@Reference
	private OfferModelArgumentsResolver _offerModelArgumentsResolver;
