...
/**
	...
	*/
public class SocialMediaNetworkManagementToolbarDisplayContext
	extends BaseManagementToolbarDisplayContext {
	
	public SocialMediaNetworkManagementToolbarDisplayContext(
		...
		return CreationMenuBuilder.addDropdownItem(
				dropdownItem -> {
					dropdownItem.setHref(
						...
						"mvcRenderCommandName", MVCCommandNames.EDIT_SOCIALMEDIANETWORK_ADMIN,
	...
	*/
	...
	public String getSearchActionURL() {		
		return PortletURLBuilder.createRenderURL(
				...
				MVCCommandNames.LIST_SOCIALMEDIANETWORK_ADMIN
			).setNavigation(
	...
	*/
	...
	public List<ViewTypeItem> getViewTypeItems() {
		...
		portletURL.setMVCRenderCommandName(MVCCommandNames.LIST_SOCIALMEDIANETWORK_ADMIN);
