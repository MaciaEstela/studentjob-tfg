...
public class StudentjobPortletKeys {
	...
	public static final String STUDENTJOB_OFFER_ADMIN = 
		"edu_uoc_mestemi_studentjob_web_portlet_StudentjobPortlet_OFFER_ADMIN";
	...
	public static final String STUDENTJOB_MYINSCRIPTIONS_USER = 
			"edu_uoc_mestemi_studentjob_web_portlet_StudentjobPortlet_MY_INSCRIPTIONS";
	...
	public static final String STUDENTJOB_DEGREEAREA_ADMIN = 
			"edu_uoc_mestemi_studentjob_web_portlet_StudentjobPortlet_DEGREEAREA_ADMIN";

	public static final String STUDENTJOB_DEGREE_ADMIN = 
			"edu_uoc_mestemi_studentjob_web_portlet_StudentjobPortlet_DEGREE_ADMIN";
	
	public static final String STUDENTJOB_SOCIALMEDIANETWORK_ADMIN = 
			"edu_uoc_mestemi_studentjob_web_portlet_StudentjobPortlet_SOCIALMEDIANETWORK_ADMIN";
