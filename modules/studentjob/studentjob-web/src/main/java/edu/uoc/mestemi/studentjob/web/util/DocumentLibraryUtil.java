...
import edu.uoc.mestemi.studentjob.web.portlet.user.companyprofile.action.EditCompanyProfileMVCRenderCommand;
...
public class DocumentLibraryUtil {
	...
	public static FileEntry addFile(ActionRequest actionRequest, String folderName, 
		...
		User adminUser = StudentJobUtil.getAdminUser(themeDisplay.getCompanyId());
	...
	public static String getFileDownloadURL(ThemeDisplay themeDisplay, long fileEntryId) throws PortalException {
