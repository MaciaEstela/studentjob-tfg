...
/**
	...
	*/
public class DegreeAreasManagementToolbarDisplayContext
	extends BaseManagementToolbarDisplayContext {
	
	public DegreeAreasManagementToolbarDisplayContext(
...
//		}
		...
		return CreationMenuBuilder.addDropdownItem(
				dropdownItem -> {
					dropdownItem.setHref(
						...
						"mvcRenderCommandName", MVCCommandNames.EDIT_DEGREEAREA_ADMIN,
	...
	*/
	...
	public String getSearchActionURL() {		
		return PortletURLBuilder.createRenderURL(
				...
				MVCCommandNames.LIST_DEGREEAREA_ADMIN
			).setNavigation(
	...
	*/
	...
	public List<ViewTypeItem> getViewTypeItems() {
		...
		portletURL.setMVCRenderCommandName(MVCCommandNames.LIST_DEGREEAREA_ADMIN);
